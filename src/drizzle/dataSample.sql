...
('Denis Wachira', 'denis@example.com', 'password123'),
('Emmanuel Kibet', 'kibet@example.com', 'password123'),
('Brian Kemboi', 'brian@example.com', 'password123'),
('Shem MUli', 'muli@example.com', 'password123');
